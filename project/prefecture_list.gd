...
func _show_prefecture_list() -> void:
	%PrefectureList.get_parent().visible = true
	%PrefListBtn.visible = false

func _hide_prefecture_list():
	%PrefectureList.get_parent().visible = false
	%PrefListBtn.visible = true
